  ...
  return (
    <div className='sectionInicio'>
      ...
      <p style={{ padding: '2rem', margin: '0', fontSize: '1rem', lineHeight: '1.6', background: 'var(--color-white-yellow)' }}>
        Somos Carina, de La Plata, y Eduardo, de Mar del Plata, estudiantes de la Tecnicatura en Desarrollo de Software a distancia del <a href='https://ifts29.edu.ar/'>Instituto de Formación Técnica Superior N° 29.</a><br/>
